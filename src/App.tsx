...
export default function App() {
  ...
  const productWithIngredientsImage = "/src/assets/images/regenerated_image_1778832083979.png";
  const bottleImage = "/src/assets/images/regenerated_image_1778832083979.png";
            ...
            <div className="bg-[#f8fbff] p-8 lg:p-12 flex flex-col items-center text-center border border-blue-100 rounded-[40px] lg:rounded-none lg:rounded-l-[60px] lg:border-r-0">
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex gap-4 opacity-50">
                  <img src="/src/assets/images/regenerated_image_1778833255343.jpg" alt="Visa" className="h-6" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative mt-12 lg:mt-0">
             <div className="aspect-[4/5] bg-gradient-to-t from-black to-brand-navy rounded-[40px] lg:rounded-[60px] overflow-hidden relative shadow-3xl border border-white/10">
                <img src="/src/assets/images/regenerated_image_1778832581190.png" alt="Healthy active older man enjoying life outdoors with high energy" className="w-full h-full object-cover mix-blend-overlay opacity-60" />
